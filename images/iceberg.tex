...
% Semantic analysis
\node [right=5pt of code-07-tex.south east, anchor=south west, text width=6.1cm, align=left] (code-08-tex) {%
  \small
...
% Flow analysis
\draw[decorate, decoration={brace, amplitude=55pt}, line width=\fboxrule, color=gray] ([yshift=-5pt] code-08-tex.north east) -- ([yshift=25pt] code-08-tex.south east) node[midway, xshift=65pt, color=black] (ch1) {\small Ch1};
\draw[decorate, decoration={brace, amplitude=10pt}, line width=\fboxrule, color=gray] ([yshift=-37.5pt] code-08-tex.north east) -- ([yshift=47.5pt] code-08-tex.south east) node[midway, xshift=20pt, color=black] (ch2) {\small Ch2};
\draw [-{Stealth[length=2mm, width=2mm, open]}, line width=\fboxrule, color=gray] ([xshift=-53pt, yshift=17pt] code-08-tex.south east) to ([xshift=32.5pt, yshift=17pt] code-08-tex.south east);
\node (ch3) at ([xshift=42.5pt, yshift=17pt] code-08-tex.south east) {\small Ch3};
\draw [-{Stealth[length=2mm, width=2mm, open]}, line width=\fboxrule, color=gray] ([xshift=-48pt, yshift=5pt] code-08-tex.south east) to ([xshift=32.5pt, yshift=5pt] code-08-tex.south east);
\node (ch4) at ([xshift=42.5pt, yshift=5pt] code-08-tex.south east) {\small Ch4};
